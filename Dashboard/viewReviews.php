<?php
    ...
    $reviews = Operations::getReviewChecker($conn);
?>
                ...
                <div class="container-fluid py-4 px-4">
                    <div class="row g-4" data-masonry='{"percentPosition": true }'>
                        ...
                        <div class="col-lg-4 col-md-6">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <h5 class="card-title"><i class="fa fa-star me-2"></i><?= $r['rating']; ?> Star</h5>
                                    <h4 class="card-title"><?= $r['name']; ?></h4>
                                    <p class="card-text"><?= $r['review']; ?></p>
                                    <a href="editReview.php?edit_id=<?= $r['id']; ?>">
                                    ...
                                    <a href="deleteReview.php?delete_id=<?= $r['id']; ?>">
